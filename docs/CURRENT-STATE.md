...
- Arquitectura aprobada: `inmobia360.com` institucional LATAM; `inmobia360.com/peru/` landing comercial Perú; `app.inmobia360.com` aplicación SaaS; `demo.inmobia360.com` demo; WordPress + Bricks para webs comerciales; Next.js separado para la aplicación.
